...
namespace RelationsNaN.Controllers
{
    public class GamesController : Controller
    {
        ...
        {
            var relationsNaNContext = await _context.Game.Include(g => g.Genre).Include(p => p.Platforms).ToListAsync();
        ...
        public async Task<IActionResult> Edit(int? id)
        {
            ...
            ViewData["GenreId"] = new SelectList(_context.Genre, "Id", "Id", game.GenreId);
            ViewData["Platform"] = new SelectList(_context.Platform, "PLatform", "Platform", game.Platforms);
            return View(game);
        }
